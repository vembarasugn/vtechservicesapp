...
function Contact(){
  ...
  //success or failure messages states
        ...
        <div className="mt-8 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded">
              <h1 className="text-3xl sm:text-3xl text-teal-400 dark:text-white font-bold tracking-tight">
               GET IN TOUCH WITH US
              </h1>
              <p className="text-normal text-lg sm:text-2xl font-medium text-gray-600 dark:text-gray-600 mt-2">
                 SEND US A MESSAGE
              </p>
              ...
              <div className="flex items-center mt-8 text-gray-600 dark:text-gray-600">
                ...
                <div className="ml-4 text-md text-gray-600 tracking-wide font-normal w-40 whitespace-normal">
                <a href="https://goo.gl/maps/27dCiCNDC4CgmwFP9" target="_blank" rel="preload" as="style">
                V-TECH RENEWABLES,#01,Ground Floor,Pinnac Apt.,Vakil Nagar,Erandwane,Pune,Maharashtra – 411004.
                </a>
                </div>
              </div>
              ...
              <div className="flex items-center mt-8 text-gray-600 dark:text-gray-600">
                ...
                <div className="ml-4 text-md tracking-wide text-gray-600 font-normal w-40 whitespace-normal">
                <a href="https://goo.gl/maps/27dCiCNDC4CgmwFP9" target="_blank" rel="preload" as="style">
                ORANGE ELECTRICAL SOLUTIONS,Kangeyam Road,Nachipalayam,Tiruppur,
                Coimbatore,Tamil Nadu - 641606
                </a>
                </div>  
              </div>
            
              <div className="flex items-center mt-4 text-gray-600 dark:text-gray-600">
                ...
                <div className="ml-4 text-md text-gray-600 tracking-wide font-normal w-40">
                +91 9098797979
                </div>
              </div>

              <div className="flex items-center mt-2 text-gray-600 dark:text-gray-600">
              ...
              <form method="post" onSubmit={handleOnSubmit} className="p-6 flex flex-col justify-center">
                <div className="flex flex-col">
                  ...
                  <input className="w-100 mt-2 py-3 px-3 rounded bg-white-100 dark:bg-gray-500 border-2 border-gray-400 dark:border-gray-500 text-gray-600 font-normal focus:border-teal-500 focus:outline-none"
                  type="text" 
                  value={firstname}
                  onChange={(e) => {
                ...
                <div className="flex flex-col">
                  ...
                  <input className="w-100 mt-2 py-3 px-3 rounded bg-white-100 dark:bg-gray-400 border-2 border-gray-400 dark:border-gray-500 text-gray-600 font-normal focus:border-teal-500 focus:outline-none"
                  type="text"
                  value={lastname}
                  onChange={(e) => {
                ...
                <div className="flex flex-col mt-2">
                  <label htmlFor="phonenumber" className="hidden">Phone Number</label>
                    <input className="w-100 mt-2 py-3 px-3 rounded bg-white-200 dark:bg-gray-400 border-2 border-gray-400 dark:border-gray-500 text-gray-600 font-normal focus:border-teal-500 focus:outline-none"
                    type="text" 
                    value={phonenumber}
                    onChange={(e) => {
                ...
                <div className="flex flex-col mt-2">
                  ...
                  <textarea className="w-100 mt-2 py-3 px-3 rounded bg-white-100 dark:bg-gray-400 border-2 border-gray-400 dark:border-gray-500 text-gray-600 font-normal focus:border-teal-500 focus:outline-none h-52"
                  type="text"
                  value={message}
                  onChange={(e) => {
                  ...
                  <button type="submit" className="md:w-32 bg-teal-400 hover:bg-teal-dark text-gray-600 font-bold py-3 px-6 rounded mt-3 hover:bg-teal-500 transition ease-in-out duration-300">
                  {buttonText}
                  </button>
                  <div>
                  {showSuccessMessage && (
