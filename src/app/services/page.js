...
const Services = () => {
  return (
    <>     
    <div className="container bg-white-300 py-32 sm:py-32">
      ...
      <div className="max-w-7xl mx-auto p-4 -mt-5 sm:p-6 lg:p-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-16 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3"> 
        <article className="flex max-w-xl flex-col items-start justify-between">
          <div className="group relative">
            <h3 className="mt-3 text-lg font-bold leading-6 text-teal-500 group-hover:text-teal-500">
              <span className="absolute inset-0 no-underline hover:underline decoration-4">ELECTRICAL PROJECTS</span>  
            </h3><br/>
            <Image src="/Electricals1.jpg" alt="Electricalimg" width={500} height={50} className="rounded"/>
            <p className="mt-5 leading-6 text-justify text-gray-600 font-sans text-base line-clamp-6">At V-TECH Renewables, we pride ourselves on our in-depth knowledge and experience in electrical projects. From initial design and planning to installation and maintenance, we provide end-to-end consulting services, ensuring that our clients electrical systems meet their specific requirements. Our team of highly skilled electrical engineers and technicians has a proven track record of delivering successful projects for various industries, including residential, commercial, and industrial sectors. We work closely with our clients, understanding their needs and delivering innovative solutions that optimize energy efficiency enhance safety, and ensure reliable power distribution.</p>
          </div>
        ...
        <article className="flex max-w-xl flex-col items-start justify-between">
          <div className="group relative">
            ...
            <Image src="/projectmanagement1.jpg" alt="projectmanagementimg" width={500} height={50} className="rounded"/>
            <p className="mt-5 leading-6 text-justify text-gray-600 font-sans text-base line-clamp-6">At V-TECH Renewables, effective project management is at the core of what we do. We understand the complexities involved in electrical and solar power projects and strive to deliver exceptional results within budget and timeline constraints. Our experienced project managers take a proactive approach, ensuring thorough planning, efficient resource allocation, and seamless coordination among various stakeholders. We keep our clients updated throughout the project's lifecycle, providing regular progress reports,and addressing any challenges that may arise. Our commitment to meticulous project management ensures successful project completion and client satisfaction.</p>
          </div>
        ...
        <div className="container mx-auto px-6 p-6">
          <div className="mb-16 text-center">
            <h1 className="mt-1.5 text-1xl lg:text-7xl font-semibold tracking-tight text-teal-500">
              WHY CHOOSE US ?
            </h1>
          </div>
          <div className="flex flex-wrap my-12">
            <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-8">
              <div className="flex items-center mb-6">
                <div className="text-lg font-bold text-teal-500 no-underline hover:underline decoration-4">QUALITY ASSURANCE</div>
              </div>
            <p className="leading-loose text-gray-600 text-justify tracking-tight ">
          ...
          <div className="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r p-8">
            <div className="flex items-center mb-6">
              <div className="text-lg font-bold text-teal-500 no-underline hover:underline decoration-4">CUSTOMIZED SOLUTIONS</div>
            </div>
            <p className="leading-loose text-gray-600 text-justify tracking-tight">
          ...
          <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-8">
            <div className="flex items-center mb-6">
              <div className="text-lg font-bold text-teal-500 no-underline hover:underline decoration-4">CUSTOMER SATISFACTION</div>
            </div>
            <p className="leading-loose text-gray-600 text-justify tracking-tight">
          ...
          <div className="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0 p-8">
            <div className="flex items-center mb-6">
              <div className="text-lg font-bold text-teal-500 no-underline hover:underline decoration-4">EXPERTISE</div>
            </div>
            <p className="leading-loose text-gray-600 text-justify tracking-tight">
